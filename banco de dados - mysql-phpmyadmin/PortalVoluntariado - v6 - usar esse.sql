...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2017 at 10:44 PM
...
--
-- Dumping data for table `vaga-pessoa`
--

INSERT INTO `vaga-pessoa` (`ID_Pessoa`, `ID_Vaga`, `DataHora`, `Observacoes`, `PresencaConfirmada`) VALUES
(1, 3, NULL, NULL, NULL);
